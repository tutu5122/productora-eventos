...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { band_type: @band.band_type, first_show: @band.first_show, members: @band.members, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { band_type: @band.band_type, first_show: @band.first_show, members: @band.members, name: @band.name } }
