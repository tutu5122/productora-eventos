...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { assistants: @concert.assistants, band_id: @concert.band_id, date: @concert.date, duration: @concert.duration, place: @concert.place } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { assistants: @concert.assistants, band_id: @concert.band_id, date: @concert.date, duration: @concert.duration, place: @concert.place } }
